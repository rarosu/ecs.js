...
describe('Component', function() {
    ...
    describe('getEntitiesByComponents', function() {
        it('should return all entities with all the specified components', function() {
            ...
            expect(transformEntities).to.not.include(entity1);
            expect(transformEntities).to.include(entity2);
            expect(transformEntities).to.not.include(entity3);
            ...
            expect(transformRenderableEntities).to.not.include(entity1);
            expect(transformRenderableEntities).to.not.include(entity2);
            expect(transformRenderableEntities).to.not.include(entity3);
